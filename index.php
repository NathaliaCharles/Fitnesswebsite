...
<body>
	...
	<section class="background firstSection">	
		<div class="box-main">
			...
			<div class="join">
				<p class="text-big">Join our RightNow training program today.</p>
				<div>
					<?php
	...
	<footer>
		<p class="text-footer">Copyright &copy;2027 www.rightnowfitness.atwebpages.com - All rights reserved.</p>
	</footer>
